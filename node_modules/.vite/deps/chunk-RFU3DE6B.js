...
var Badge = React24.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime17.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime16.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
true ? Button.propTypes = {
   ...
   * @default 'button'
   */
  rootElementName: import_prop_types19.default.string,
  /**
...
true ? Dropdown.propTypes = {
   ...
   */
  onOpenChange: import_prop_types20.default.func,
  /**
...
var FormControlContext2 = React31.createContext(void 0);
if (true) {
...
function useFormControlContext() {
  return React33.useContext(FormControlContext2);
}
...
function useList(params) {
  ...
  const actionContext = React37.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React42.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
...
true ? Menu.propTypes = {
   ...
   */
  onItemsChange: import_prop_types24.default.func,
  /**
...
true ? MenuItem2.propTypes = {
   ...
   * @default false
   */
  disableFocusOnHover: import_prop_types26.default.bool,
  /**
...
true ? NumberInput.propTypes = {
   ...
   */
  shiftMultiplier: import_prop_types28.default.number,
  /**
   * The props used for each slot inside the NumberInput.
   * @default {}
   */
  slotProps: import_prop_types28.default.shape({
    decrementButton: import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object]),
    incrementButton: import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object]),
  ...
  slots: import_prop_types28.default.shape({
    decrementButton: import_prop_types28.default.elementType,
    incrementButton: import_prop_types28.default.elementType,
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime37.jsx)(React67.Fragment, {
...
var Select = React67.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React67.Fragment, {
...
var Tabs = React79.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime49.jsx)(TabsRoot2, _extends({}, tabsRootProps, {
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime64.jsx)("path", {
...
var Chip = React98.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React98.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size: size3,
    color,
    iconColor: React98.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React98.isValidElement(deleteIconProp) ? React98.cloneElement(deleteIconProp, {
      className: clsx_default(deleteIconProp.props.className, classes.deleteIcon),
      onClick: handleDeleteIconClick
    }) : (0, import_jsx_runtime65.jsx)(Cancel_default, {
      className: clsx_default(classes.deleteIcon),
      onClick: handleDeleteIconClick
    });
  }
  let avatar = null;
  if (avatarProp && React98.isValidElement(avatarProp)) {
    avatar = React98.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React98.isValidElement(iconProp)) {
    icon = React98.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime66.jsxs)(ChipRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ...
    children: [avatar || icon, (0, import_jsx_runtime65.jsx)(ChipLabel, {
...
var TabScrollButton = React101.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime69.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime69.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
function ScrollbarSize(props) {
  ...
  return (0, import_jsx_runtime70.jsx)("div", _extends({
    style: styles3,
    ref: nodeRef
  }, other));
}
...
var Tabs3 = React103.forwardRef(function Tabs4(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime71.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime71.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime71.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime71.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime72.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime72.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime71.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RFU3DE6B.js.map
